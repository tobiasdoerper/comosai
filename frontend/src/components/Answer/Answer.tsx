    ...
    const HelpfulFeedbackContent = () => {
        return (<>
            ...
            <Stack tokens={{ childrenGap: 4 }}>
                ...
                <Checkbox label="It helps me to solve a problem" id={Feedback.SolvedProblem} defaultChecked={positiveFeedbackList.includes(Feedback.SolvedProblem)} onChange={updatePositiveFeedbackList}></Checkbox>
